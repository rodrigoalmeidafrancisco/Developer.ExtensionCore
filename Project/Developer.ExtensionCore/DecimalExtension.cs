...
namespace Developer.ExtensionCore
{
    public static class DecimalExtension
    {
        ...
        /// <param name="cultureInfo"></param>
        /// <returns></returns>
        public static decimal? ToDecimalNull(this string val, NumberStyles style, string cultureInfo)
        {
            decimal? valueReturn = null;
        ...
        /// <param name="cultureInfo"></param>
        /// <returns></returns>
        public static decimal? ToDecimalNull(this string val, NumberStyles style, EnumCultureInfo cultureInfo)
        {
            decimal? valueReturn = val.ToDecimalNull(style, cultureInfo.GetDescription());
            return valueReturn;
        }
